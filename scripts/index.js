...
x = setInterval(function() {
  let now = new Date().getTime(),
    ...
    // test code to see if it was parsing the date correctly
    // console.log(new Date(config.birthdate));
    ...
    if (this.phase === 'firework') {
      ...
      if (this.circleCreating) {
        ...
        ctx.fillStyle = this.lightAlphaColor
          .replace('semi-bold', 50 + 50 * proportion)
        ...
        ctx.fillStyle = this.lightColor.replace('semi-bold', 70);
